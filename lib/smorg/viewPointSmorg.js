...
sb.ViewerSmorg = sb.Smorg.subType({
    ...
    setViewPoint:function(toViewerVector, lookatpointVector) {
      console.log('setting view point');
        ...
        this._attitude = new sb.Matrix2d().setMatrixFromVectors(new sb.Vector(1.0, 0.0), new sb.Vector(0.0, 1.0), this._position);
    ...
    lookAt:function(targetpos)
    {
        ...
        newTangent = new sb.Vector().setFromVector(targetpos.diff(this._position));  // vector maths!
        ...
        this.setAttitude(new sb.Matrix2d().setMatrixFromVectors(newTangent, newNormal, _position));
