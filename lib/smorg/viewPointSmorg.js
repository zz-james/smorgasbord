...
sb.ViewerSmorg = sb.Smorg.subType({
   ...
   draw:function() {
    ...
    update:function() {
        ...
        var trackee = this.trackee.position;
        document.getElementById("ui").innerHTML = "x is "+trackee.x+"<br /> y is "+trackee.y;

        this.position.init(trackee.x * sb.SCALE,trackee.y * sb.SCALE); // directly sets position vector without making a new vec
