...
/**
 * sets the game view
 * @param graphicsclass - string with the name of the class
 */
sb.setGameView = function(graphicsclass) {
    sb._VIEW = new sb.View({ _graphics:new graphicsclass(), _game:sb._GAME });
};
