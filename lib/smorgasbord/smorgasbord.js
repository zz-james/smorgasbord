...
require([
    ...
    "resources/attributes/attributes3.js"
    ], function() {
        sb.serve();
});
...
sb._MSDURATION = 0; //microseconds elapsed between each frame
sb._LASTTIME = Date.now();
...
sb.update = function() {
    var now = Date.now();
    sb._MSDURATION = now - sb._LASTTIME;
    sb._LASTTIME = now;
