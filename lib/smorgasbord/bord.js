...
sb.Bord = Object.subType({
     ...
     *
     * @param size - width and height of game world in pixels
     * @param border - colour of game world border
     * @param background - any bitmap used as background
     * @param wrapped  - whether game is wrapped or has edges
     * @param player  - what class is the player smorg
     * @param permanent  - what 'permanent' smorgs are there?
     */
    init:function(size, wrapped, player, permanent) {
        console.log("I am a bord");
        this._smorgCount(COUNTSTART);
        this._gameOver = true;
        ...
        _smorgs = new SmorgList(this);        // what is the smorglist class? a container!!
